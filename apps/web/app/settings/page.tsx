...
export default function SettingsPage() {
  ...
  // Profile state (start from session, then hydrate from API)
              ...
              {activeTab === "profile" && (
                <div className="border-2 border-foreground bg-card shadow-retro flex flex-col">
                  ...
                  <div className="p-6 flex flex-col gap-6">
                    ...
                    <motion.button
                      ...
                      whileHover={
                        !saving
                          ? {
                              scale: 1.03,
                              boxShadow: "4px 4px 0px 0px hsl(var(--navy))",
                            }
                          : {}
                      }
                      whileTap={
                    ...
                    {message && (
                      <p className="text-[10px] mt-2 font-mono text-muted-foreground">
                        {message}
                      </p>
                    )}
                  </div>
                    ...
                    {[
                      {
                        key: "matchStart",
                        label: "Match Start",
                        desc: "Get notified when your match begins.",
                      },
                      {
                        key: "roundResult",
                        label: "Round Results",
                        desc: "Receive verdict and score after each round.",
                      },
                      {
                        key: "newChallenge",
                        label: "New Challenges",
                        desc: "Notify when new challenge sets are live.",
                      },
                      {
                        key: "weeklyDigest",
                        label: "Weekly Digest",
                      ...
                      },
                      {
                        ...
                        desc: "News, features, and announcements.",
                      },
                    ].map((item) => (
                      <div
                        key={item.key}
